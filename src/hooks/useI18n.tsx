...
const translations = {
  ...
  // Index / Create
  "create.badge":                { en: "No code required",        ru: "Без кода" },
  "create.title":                { en: "Build your Telegram Bot", ru: "Создайте Telegram-бота" },
  "create.subtitle":             { en: "Describe your business in plain language — we generate the AI brain and guide you through deployment.", ru: "Опишите бизнес простым языком — мы создадим AI-мозг и проведём через деплой." },
  "create.api_key_placeholder":  { en: "sk-...",                  ru: "sk-..." },
  "create.api_key_label":        { en: "OpenAI API Key (your key — your cost)", ru: "OpenAI API ключ (ваш ключ — ваши расходы)" },
  "create.api_key_hint":         { en: "We use your key to generate the bot brain. Get one at platform.openai.com", ru: "Используем ваш ключ для генерации мозга бота. Получить: platform.openai.com" },
  "create.api_key_error":        { en: "Key must start with sk-", ru: "Ключ должен начинаться с sk-" },
  "create.api_key_needed":       { en: "You'll need an OpenAI API key to generate the bot brain.", ru: "Для генерации нужен OpenAI API ключ." },
  "create.instructions_label":   { en: "Describe your bot",       ru: "Опишите вашего бота" },
  "create.bot_name":             { en: "Bot Name",                ru: "Имя бота" },
  "create.bot_name_placeholder": { en: "e.g., Flora Assistant",   ru: "напр., Флора Ассистент" },
  "create.optional":             { en: "(optional)",              ru: "(необязательно)" },
  "create.advanced":             { en: "Advanced settings",       ru: "Расширенные настройки" },
  ...
  // How it works steps
  "how.step1_title":  { en: "Describe",   ru: "Опишите" },
  "how.step1_desc":   { en: "Tell us what your bot does in plain language", ru: "Расскажите о боте простыми словами" },
  "how.step2_title":  { en: "Generate",   ru: "Генерируем" },
  "how.step2_desc":   { en: "AI builds the brain — logic, tone, behavior", ru: "AI создаёт мозг — логику, тон, поведение" },
  "how.step3_title":  { en: "Deploy",     ru: "Деплой" },
  "how.step3_desc":   { en: "Wizard guides you through Telegram setup", ru: "Визард проведёт через настройку Telegram" },
