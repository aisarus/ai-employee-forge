...
export function StepTelegramConfig({ data, onChange }: Props) {
  ...
  // Live token validation with debounce
  useEffect(() => {
    ...
    // Rough format check: digits:alphanum (at least 30 chars)
      ...
      <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 space-y-2">
        ...
        <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
          ...
          <li>
            ...
            <code className="text-xs bg-muted px-1 py-0.5 rounded">/newbot</code>{" "}
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2">
            ...
            {tokenState === "valid"   && <CheckCircle2 className="h-4 w-4 text-green-500" />}
