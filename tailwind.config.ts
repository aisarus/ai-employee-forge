  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "thinking":        "thinking-bounce 1.4s ease-in-out infinite",
        "wiggle":          "wiggle 0.45s ease both",
        "pop-in":          "pop-in 0.32s cubic-bezier(0.34,1.56,0.64,1) both",
        "slide-down-fade": "slide-down-fade 0.2s cubic-bezier(0.34,1.2,0.64,1) both",
        "spin-once":       "spin-once 0.55s cubic-bezier(0.4,0,0.2,1) both",
        "gen-shimmer":     "gen-shimmer 1.6s ease-in-out infinite",
      },
    },
  },
